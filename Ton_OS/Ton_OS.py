...
def OpenMyPC():
    ...
    def check_sysinfo():
        ...
        System_info_label_1 = tk.Label(System_info, text="CPU : Intel® Core™ i7-7700K : 4.50 GHz", font=("Arial", 28), bg="#949494")
        System_info_label_1.place(x=130, y=35)

        System_info_label_2 = tk.Label(System_info, text="GPU : AMD Radeon RX 6700 XT", font=("Arial", 28), bg="#949494")
        System_info_label_2.place(x=130, y=135)

        System_info_label_3 = tk.Label(System_info, text="Motherboard : ASUS ROG Strix Z270E Gaming", font=("Arial", 26), bg="#949494")
        System_info_label_3.place(x=130, y=235)

        System_info_label_4 = tk.Label(System_info, text="RAM : 16GB DDR4 3800 MHz", font=("Arial", 28), bg="#949494")
        System_info_label_4.place(x=130, y=335)

        System_info_label_5 = tk.Label(System_info, text="PSU : Corsair RM750x (750W, 80+ Gold)", font=("Arial", 28), bg="#949494")
        System_info_label_5.place(x=130, y=435)

        System_info_label_5 = tk.Label(System_info, text="Memory : NVMe SSD Crucial P5 2TB", font=("Arial", 28), bg="#949494")
        System_info_label_5.place(x=130, y=535)
    ...
    def openDrivers():
        ...
        GPU_Driver_button.place(x=340, y=180)

        Memory_Driver_Button = tk.Button(Drivers, text="Check for driver updates", font=("Arial", 26), command=Check_driver_upd, bg="#6b6b6b", activebackground="#949494")
        Memory_Driver_Button.place(x=270, y=300)

    def Check_driver_upd():
        messagebox.showinfo("Driver updates", "No new driver updates")
    ...
    def openGPU_Drivers_menu():
        ...
        DRV_GPU_missing_label.place(x=315, y=60)

        UI_GDM_label = tk.Label(GPU_Drivers_menu, text="", font=("Arial", 24), width=23, height=4, bg="#1c1c1c")
        UI_GDM_label.place(x=245, y=130)

        Install_missing_GPU_drivers_button = tk.Button(GPU_Drivers_menu, text="Install missing drivers", font=("Arial", 26), bg="#6b6b6b", activebackground="#949494", command=no_missing_GPU_drivers)
        Install_missing_GPU_drivers_button.place(x=285, y=173)
        ...
        UI_GDU_label = tk.Label(GPU_Drivers_menu, text="", font=("Arial", 24), width=23, height=4, bg="#1c1c1c")
        UI_GDU_label.place(x=245, y=390)

        Install_GPU_driver_updates = tk.Button(GPU_Drivers_menu, text="Install driver updates", font=("Arial", 26), bg="#6b6b6b", activebackground="#949494", command=no_missing_GPU_driver_updates)
        Install_GPU_driver_updates.place(x=285, y=433)

    def no_missing_GPU_drivers():
        messagebox.showerror("No missing drivers", "No missing GPU drivers!")

    def no_missing_GPU_driver_updates():
        messagebox.showerror("No missing driver updates", "No missing GPU driver updates!")
